...
@section('content')
    ...
    <section class="w-[50%] px-5 py-5 flex flex-col gap-5 rounded-md shadow-md m-auto">
        <h2 class="text-3xl font-bold m-auto">Submit A Review</h2>
        <form action="" class="flex flex-col gap-2">
            <label for="name">Name:</label>
            <input type="text" name="name" id="name" class="border border-black outline-none p-2 mb-5" required>
